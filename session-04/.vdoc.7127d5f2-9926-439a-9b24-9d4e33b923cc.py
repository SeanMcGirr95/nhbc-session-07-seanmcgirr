...
def convert_calendar_to_fiscal_udf(calendar_quarter: str) -> str:
    ...
    year = int(PROCESSINGQUARTER[:4])
    quarter = PROCESSINGQUARTER[-2:]  # e.g., 'Q1', 'Q2'
    ...
    if quarter == 'Q1':
        ...
        raise ValueError("Invalid quarter format. Must be Q1, Q2, Q3, or Q4.")
...
#
#
claims_data.select("ProcessingQuarter", "ProcessingFYQuarter").sample(n = 50)
#
#
#
#
